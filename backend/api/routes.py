...
api_router.include_router(extraction.router, prefix="/v1/extraction", tags=["extraction"])
api_router.include_router(mapping.router,    prefix="/v1/mapping",    tags=["mapping"])
api_router.include_router(grading.router,    prefix="/v1/grading",    tags=["grading"])
